        ...
        <div class="navbar-container position-relative">
          ...
          <div v-if="user.visibilidadeNaoLogado">
            <div
              ...
              class="d-flex align-center ga-15"
            >
              <div
              ...
              <v-menu :location="location">
                ...
                <v-list class="d-flex flex-column ga-2 pa-2 mt-2">
                  <v-btn
                    ...
                    to="/empresa-candidato?resposta=entrar"
                    >Entrar</v-btn
                  >
                  <v-divider></v-divider>
                  <v-btn
                    ...
                    to="/empresa-candidato?resposta=cadastro"
                    >Cadastrar</v-btn
                  >
                  <v-divider></v-divider>
                  <v-btn
            ...
            <v-menu min-width="200px" rounded>
              <template v-slot:activator="{ props }">
                <v-btn icon v-bind="props">
                  <v-avatar
                    v-if="user.dadosUser.foto"
                    :image="user.dadosUser.foto"
                    size="45"
                  ></v-avatar>
                </v-btn>
              </template>
