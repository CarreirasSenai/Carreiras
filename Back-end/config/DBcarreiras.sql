...
INSERT INTO `questionario` VALUES (2,'alternativa','Há quanto tempo vc fala inglês?','[\"1 a 2 anos\", \"3 a 4 anos\", \"5 anos\", \"sou fluente\", \"oque é ingles\"]','5 anos',101,'2024-10-12 01:05:50'),(7,'discursiva','Fale um pouco sobre você','[]',NULL,105,'2024-10-14 03:40:07'),(8,'alternativa','Há quanto tempo você usa Node.js no trabalho?','[\"1 ano\", \"2 anos\", \"Nunca  usei\"]','2 anos',105,'2024-10-14 07:59:47'),(9,'alternativa','Você tem experiência com programação?','[\"Sim\", \"Não\", \"Um pouco\"]','Sim',105,'2024-10-14 03:43:17'),(11,'discursiva','Teste 123','[]','',107,'2024-10-14 17:31:32'),(12,'alternativa','Teste 123','[\"1\", \"2\", \"34\"]','2',107,'2024-10-14 17:31:51');
...
INSERT INTO `vagas` VALUES (4,'Desenvolvedor Junior','87775-435','Mafra','SC','Estágio','Presencial','Júnior','600,00','[\"JavaScript\", \"Vuejs\", \"react\", \"Angular\", \"Uma banheira do gugu\", \"3 soletrando\"]','[\"Boa comunication\"]','A vaga é uma vaga muito boa e precisa ser muito bom para essa vaga. Só quem é muito bom poderá passar nessa vaga, então se você é bom se inscreva nela.',NULL,1,'2024-09-10 07:24:44'),(101,'Analista de Dados','87775-435','Joinville','SC','CLT','Remoto','Júnior','3.000,00','[\"Pacote Office\", \"Lógica de Programação\", \"Trabalho em Equipe\"]','[\"Malabarismo\", \"Conserto de Veículos\", \"Plantar Bananeira\"]','A vaga é uma vaga muito boa e precisa ser muito bom para essa vaga. Só quem é muito bom poderá passar nessa vaga, então se você é bom se inscreva nela.',100,18,'2024-10-12 01:04:17'),(105,'Analista de Dados','87775-435','Joinville','SC','CLT','Remoto','Júnior','3.000,00','[\"Pacote Office\", \"Lógica de Programação\", \"Trabalho em Equipe\"]','[\"Malabarismo\", \"Conserto de Veículos\", \"Plantar Bananeira\"]','A vaga é uma vaga muito boa e precisa ser muito bom para essa vaga. Só quem é muito bom poderá passar nessa vaga, então se você é bom se inscreva nela.',100,18,'2024-10-14 03:39:42'),(107,'Analista de Dados','87775-435','Joinville','SC','CLT','Remoto','Júnior','3.000,00','[\"Pacote Office\", \"Lógica de Programação\", \"Trabalho em Equipe\"]','[\"Malabarismo\", \"Conserto de Veículos\", \"Plantar Bananeira\"]','A vaga é uma vaga muito boa e precisa ser muito bom para essa vaga. Só quem é muito bom poderá passar nessa vaga, então se você é bom se inscreva nela.',100,18,'2024-10-14 08:02:23');
...
-- Dump completed on 2024-10-14 18:52:44
